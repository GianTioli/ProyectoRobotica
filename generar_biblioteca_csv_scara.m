%% SCARA: generar biblioteca de CSV precomputados
clear; clc; close all;
...
fprintf('Archivos: todos.csv, pozo_1.csv, ..., pozo_6.csv\n');
...
function generarCSV(nombre_archivo, orden, muestras, pozos, robot, actuator, tubo, task, cfg, csv_dir)
    ...
    fprintf('CSV generado: %-12s | hoyos: %-15s | filas: %d\n', ...
        nombre_archivo, mat2str(orden), size(tabla_csv,1));
end
